...
export class Simulador extends Phaser.Scene {
    ...
    createButtons() {
        ...
        this.createStyledButton(400, baseY, 'Volver', () => this.scene.start('Inicio'), buttonHeight);
        this.createTextButton(800, baseY, 'Comprobar Ubicaciones', this.comprobarUbicaciones.bind(this), buttonHeight);
